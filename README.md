Modified slightly from https://homework.adhoc.team/fetch/ while we build our own assessments

# Fetch

At the NYC Digital Service, our front-end applications often exchange JSON data with various RESTful APIs. We use modern JavaScript
